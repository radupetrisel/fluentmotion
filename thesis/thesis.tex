...
\footnotetext{Image from \cite{Figure11}}
...
\footnotetext{Image from \cite{Figure12}}
...
\footnotetext[1]{Image from \cite{VIVECONTROLLERS}}
\footnotetext[2]{Image from \cite{OCCULUSTOUCH}}
...
\begin{figure}[h]
  ...
  \label{mfig:hands}
\end{figure}
\footnotetext{Images courtesy of \cite{HANDS}}
...
\footnotetext[1]{Image from \cite{LEAPCTRL}}
...
\footnotetext{Image from \cite{CAPSULE_HANDS}}
...
\footnotetext{Image from \cite{LEAP_BONES}}
...
\footnotetext{Image from \cite{RX_FILTER}}
