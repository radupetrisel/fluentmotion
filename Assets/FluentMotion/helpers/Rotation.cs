...
namespace FluentMotion.helpers
{
    ...
    {
        public static Quaternion Right(float degrees) => Quaternion.AngleAxis(degrees, Vector3.down);
        public static Quaternion Left(float degrees) => Quaternion.AngleAxis(degrees, Vector3.up);
