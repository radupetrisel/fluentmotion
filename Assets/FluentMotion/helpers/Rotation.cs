...
namespace FluentMotion.helpers
{
    ...
    {
        public static Quaternion Right(float degrees) => Quaternion.AngleAxis(degrees, Camera.main.transform.up);
        public static Quaternion Left(float degrees) => Quaternion.AngleAxis(- degrees, Camera.main.transform.up);
